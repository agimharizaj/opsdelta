    ...
    <section className="relative bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white mb-6 leading-tight">
          See where you're <span className="text-orange-600 italic">losing time</span>
        </h1>
        <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed font-medium">
          Free 10-minute process audit. Get a personalized automation roadmap and see exactly where you can reclaim time and money. Then book a call to execute.
        </p>
        <button
          onClick={onStart}
